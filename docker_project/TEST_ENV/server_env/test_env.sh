...
#docker rmi chngenesis/pro:$version
#docker rmi chngenesis/his:$version
#docker rmi chngenesis/emr:$version
...
docker run -dit --name pro --restart=always --link=zookeeper  chngenesis/pro:$version
sleep 120
docker run -dit -p 8070:8080 --name his --restart=always --link=zookeeper chngenesis/his:$version
docker run -dit -p 8072:8080 --name emr --restart=always --link=zookeeper chngenesis/emr:$version
